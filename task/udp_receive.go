...
func ReceiveDataFromClient(conn *net.UDPConn, statusSender chan<- *protodef.Status, initWorker *sync.WaitGroup, mutualTerminationSignal chan bool, sendMutualTerminationSignal func(chan bool)) {
